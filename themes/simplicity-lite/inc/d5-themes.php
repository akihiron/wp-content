...
<div id="about-page">
	...
	<div class="floatcntr">
        ...
        <div class="width85 featured-boxs">
			...
			<a href="<?php echo esc_url('http://d5creation.com/theme/simplicity/' ) ?>" target="_blank">
				<div class="view view-sixth">
					<img alt="Responsive WordPress Theme" src="<?php echo get_template_directory_uri() . '/inc/images/simplicity.png' ?>" />
					<div class="mask">
						<h2>Simplicity</h2>
